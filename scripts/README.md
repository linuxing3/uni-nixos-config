...
btrfs subvolume create /mnt/@boot # create-btrfs
...
mount -o compress-force=zstd:1,noatime,subvol=@boot /dev/mapper/crypted-nixos /mnt/boot # mount-1
...
# mount /dev/sdb3 /mnt/boot  # mount-1
